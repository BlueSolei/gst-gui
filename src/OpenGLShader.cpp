...
void OpenGLShader::init(const std::string &vertex_code,
...
void OpenGLShader::use() { glUseProgram(id_); }

template <>
void OpenGLShader::setUniform<int>(const std::string &name, int val) {
  glUniform1i(glGetUniformLocation(id_, name.c_str()), val);
}

template <>
void OpenGLShader::setUniform<bool>(const std::string &name, bool val) {
  glUniform1i(glGetUniformLocation(id_, name.c_str()), val);
}

template <>
void OpenGLShader::setUniform<float>(const std::string &name, float val) {
  glUniform1f(glGetUniformLocation(id_, name.c_str()), val);
}

template <>
void OpenGLShader::setUniform<float>(const std::string &name, float val1,
                                     float val2) {
